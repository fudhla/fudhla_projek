    ...
    <div class="flex items-center space-x-2">
        ...
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0h6m-6 0v-4m0 0h6v4">
            </path>
        </svg>
    ...
    <div class="flex items-center space-x-6">
        ...
        <a href="{{ route('user.index') }}"
            ...
            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm-6-2.646l3-3.001 3 3.001v-1a6 6 0 00-6 0v1z">
                </path>
            </svg>
            User
        </a>
        {{-- 4. Warga (Ikon Umum untuk Komunitas/Grup) --}}
        <a
            href="{{ route('warga.index') }}"class="nav-link flex items-center hover:text-blue-200 transition duration-200">
            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
