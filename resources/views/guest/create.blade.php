        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="index.html" class="nav-item nav-link"><i class="fa fa-building me-2"></i>Fasilitas Desa</a>
                    <a href="{{route('form.store')}}" class="nav-item nav-link active"><i class="fa fa-calendar-check me-2"></i>Formulir Peminjaman</a>
                    ...
                    <form action="{{ route('fasilitas.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select" id="nama_fasilitas" name="fasilitas_id" required>
                                    ...
                                    <option value="1">Balai Desa Serbaguna</option>
                                    <option value="2">Lapangan Olahraga</option>
                                    <option value="3">Ruang Rapat Kecil</option>
                                </select>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="kegiatan" class="col-sm-3 col-form-label">Nama/Tujuan Kegiatan</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="kegiatan" name="tujuan" placeholder="Contoh: Rapat Koordinasi RT 03 / Latihan Voli" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="form-text">Maksimal ukuran file 2MB (format PDF/JPG).</div>
                            </div>
                        </div>
