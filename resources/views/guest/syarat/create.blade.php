...
<div class="p-6 bg-gray-50 min-h-screen flex justify-center">
    <div class="w-full max-w-2xl">
        ...
        {{-- Tombol Kembali --}}
        <div class="mb-4">
            <a href="{{ route('syarat.index') }}" class="text-gray-500 hover:text-blue-600 flex items-center text-sm font-medium transition-colors group">
        ...
        <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
            ...
            <div class="bg-blue-600 p-6 text-white">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-xs opacity-80">Lengkapi formulir di bawah untuk menambah ketentuan fasilitas.</p>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('syarat.store') }}" method="POST" class="p-8 space-y-6">
                ...
                {{-- Pilih Fasilitas --}}
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Fasilitas Umum</label>
                    <div class="relative">
                        <select name="fasilitas_id" class="w-full pl-4 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all appearance-none cursor-pointer text-gray-700 font-medium">
                ...
                {{-- Nama Syarat --}}
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Nama Syarat</label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <p class="mt-2 text-[10px] text-gray-400 italic font-medium tracking-wide">*Deskripsi ini akan tampil saat warga melakukan peminjaman.</p>
                </div>

                {{-- Tombol Submit --}}
                <div class="pt-4">
                    <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-100 transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2">
