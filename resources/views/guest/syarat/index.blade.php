    ...
    <div class="p-6 bg-gray-50 min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse ($data as $item)
                <div
                    class="bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 overflow-hidden flex flex-col group">
                    <div class="p-6 flex-grow">
                        ...
                        <img src="{{ $foto ? asset('storage/' . $foto->file_url) : asset('assets/images/default.jpg') }}"
                            class="w-full h-40 object-cover rounded-xl mb-4" alt="Dokumen Syarat">

                        {{-- Nama Fasilitas (Badge Biru) --}}
                        <div class="mb-4">
                            <span
                                class="inline-flex items-center px-3 py-1 rounded-lg text-xs font-bold bg-blue-50 text-blue-700 uppercase tracking-wider">
                        ...
                        <div class="flex items-start gap-4">
                            <div
                                class="hidden sm:flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-blue-100 text-blue-600 group-hover:scale-110 transition-transform">
                                <i class="fas fa-file-signature text-sm"></i>
                            </div>
                            <div>
                                <label class="block text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-1">Nama
            ...
            @empty
                ...
                <div class="col-span-full bg-white rounded-3xl p-16 text-center border-2 border-dashed border-gray-200">
                    <div
                        class="inline-flex items-center justify-center w-20 h-20 bg-blue-50 text-blue-400 rounded-full mb-6">
                    ...
                    <a href="{{ route('syarat.create') }}"
                        class="mt-6 inline-block text-blue-600 font-bold hover:underline">Tambah Sekarang</a>
                </div>
            @endforelse
        </div>
    </div>
