    ...
    <div class="p-6 bg-gray-50 min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse ($pembayaran as $item)
                <div
                    class="bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300 overflow-hidden flex flex-col">
                    <div class="p-5 flex-grow">
                        ...
                        <img src="{{ $foto ? asset('storage/' . $foto->file_url) : asset('assets/images/default.jpg') }}"
                            class="w-full h-40 object-cover rounded-xl mb-4" alt="Bukti Pembayaran">

                        {{-- Badge Tanggal & Metode --}}
                        <div class="flex justify-between items-start mb-4">
                            <div
                                class="bg-blue-50 text-blue-700 text-xs font-bold px-3 py-1 rounded-lg uppercase tracking-wider">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-2xl font-bold text-gray-800">
                                <span class="text-gray-400 text-lg font-medium">Rp</span>
